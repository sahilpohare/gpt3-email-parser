...
<html lang="en">
  <head>
    ...
    <title>AquiGorka invited you to getmailscript/gpt3-api</title>
...
<!--/.row.header-->
  ...
  <img class="avatar avatar-user" src="https://avatars1.githubusercontent.com/u/3072458?s=120&amp;v=4" width="60" height="60" alt="@AquiGorka" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: auto; max-width: 100%; overflow: hidden; -webkit-border-radius: 3px; border-radius: 3px;">
...
<p style="word-wrap: normal; hyphens: none; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: normal; color: #333; line-height: 20px; text-align: left; margin: 15px 0 5px; padding: 0;" align="left">
  You can <a href="https://github.com/getmailscript/gpt3-api/invitations" style="color: #4183C4; text-decoration: none;">accept or decline</a> this invitation.
    You can also visit <a href="https://github.com/AquiGorka" style="color: #4183C4; text-decoration: none;">@AquiGorka</a> to learn a bit more about them.
</p>
<p style="word-wrap: normal; hyphens: none; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: normal; color: #333; line-height: 20px; text-align: left; margin: 15px 0 5px; padding: 0;" align="left">
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://github.com/getmailscript/gpt3-api/invitations" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#4183C4">
  <w:anchorlock/>
  <center>
<![endif]-->
    <a class="cta-button" href="https://github.com/getmailscript/gpt3-api/invitations" style="display: inline-block; color: #fff; font-size: 14px; font-weight: 600; text-decoration: none; width: auto !important; text-align: center; border-radius: 5px; -webkit-border-radius: 5px; box-shadow: 0px 3px 0px #25588c; letter-spacing: normal; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; -webkit-text-size-adjust: none; background: #28A73F linear-gradient(-180deg, #34d058 0%, #28a745 90%); margin: 0 auto; padding: 6px 12px;">View invitation</a>
<!--[if mso]>
  </center>
</v:roundrect>
<![endif]-->
...
<p class="email-body-subtext" style="word-wrap: normal; hyphens: none; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; color: #333; line-height: 20px; text-align: left; margin: 15px 0 5px; padding: 0;" align="left">
  ...
  If you were not expecting this invitation, you can ignore this email.
    If  @AquiGorka is sending you too many emails, you can
    <a href="https://github.com/settings/blocked_users?block_user=AquiGorka" style="color: #4183C4; text-decoration: none;">block them</a>
    or <a href="https://github.com/contact/report-abuse?report=AquiGorka" style="color: #4183C4; text-decoration: none;">report abuse</a>.
</p>
...
<p class="email-text-small email-text-gray" style="word-wrap: normal; hyphens: none; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; font-weight: normal; color: #777777; line-height: 20px; text-align: left; margin: 15px 0 5px; padding: 0;" align="left">
  ...
  <br><a href="https://github.com/getmailscript/gpt3-api/invitations" style="color: #4183C4; text-decoration: none;">https://github.com/getmailscript/gpt3-api/invitations</a>
</p>
